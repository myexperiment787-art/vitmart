...
export default function CarServicePage() {
  ...
  const cars = [
    {
      name: "Baleno Delta Petrol+CNG",
      price: 3500,
      image: "/cars/baleno-delta-petrol-cng.jpg",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Comfortable and reliable car rentals for daily and outstation travel
          </p>
        </div>
          ...
          {cars.map((car) => (
            <div
              ...
              style={{
                ...
                borderRadius: "24px",
                overflow: "hidden",
                boxShadow: hoveredCar === car.name 
                  ? `0 20px 40px ${car.color}44`
                  : "0 8px 24px rgba(0,0,0,0.1)",
                transition: "all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                transform: hoveredCar === car.name 
                  ? "translateY(-12px) scale(1.02)" 
                  : "translateY(0) scale(1)",
                border: hoveredCar === car.name 
                  ? `3px solid ${car.color}`
            ...
            >
              ...
              <div style={{
                ...
                <Image
                  ...
                  style={{
                    ...
                    transform: hoveredCar === car.name ? "scale(1.1)" : "scale(1)",
                  }}
                  priority
                />
                {/* Gradient Overlay */}
                <div style={{
                  ...
                  right: 0,
                  bottom: 0,
                  background: hoveredCar === car.name 
                    ? car.gradient
                    : "transparent",
                  opacity: hoveredCar === car.name ? 0.3 : 0,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  borderRadius: "50px",
                  marginBottom: "20px",
                  boxShadow: `0 4px 15px ${car.color}44`,
                }}>
                  <p style={{
                    fontSize: "22px",
                    fontWeight: "800",
                ...
                {/* WhatsApp Button */}
                <a
                  href={`https://wa.me/${whatsappNumber}?text=Hello,%20I%20want%20to%20book%20${car.name}%20car%20service%20for%2024%20hours`}
                  target="_blank"
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              ...
              { emoji: "🧼", text: "Clean Cars" },
              { emoji: "🛡️", text: "Safe & Verified" },
            ].map((feature, index) => (
              <div key={index} style={{
                padding: "16px",
                borderRadius: "16px",
